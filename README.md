...
## Architecture
- `app/frontend/` — Next.js 15 App Router, TypeScript, Tailwind v4. Six destinations: Dashboard, Intelligence, Reports, Clients, Collection, Manage. Screens read the backend through `app/frontend/lib/api.ts`; `app/frontend/fixtures/` is the offline fallback and is never presented as live data.
